<template>
  <div>
    ...
    <div class="container mt-5">
      <div class="card p-4 shadow w-100 mb-4" style="max-width: 900px; margin:auto;">        <div class="d-flex justify-content-between align-items-center mb-3">
          <h3 class="mb-0">Listado de usuarios</h3>
          <div>
            <button class="btn btn-outline-secondary me-2" @click="forceSync">
              <i class="fas fa-sync"></i> Sincronizar perfiles
            </button>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li><button class="dropdown-item" @click="openEditModal(u)"><i class="fas fa-edit me-2"></i> Editar</button></li>
                      <li><button class="dropdown-item" @click="viewUserDetails(u)"><i class="fas fa-info-circle me-2"></i> Ver detalles</button></li>
                      <li><hr class="dropdown-divider"></li>
                      <li><button class="dropdown-item text-danger" @click="deleteUser(u)"><i class="fas fa-trash-alt me-2"></i> Eliminar</button></li>
                    </ul>
                  </div>
                </td>
              </tr>
